...
if(isset($_POST['add'])){
    ...
    $type = $_POST['type'];
      ...
      $select_query = mysqli_query($connection,$query1);
        ...
        if($pname == $name){
            $message = "product already in the stock";
        }
    else{
      
    
    $query = "insert into stock(name,type,quantity)";
    $query .= "values('{$pname}','{$type}','{$quantity}')";
    
    $stock_query = mysqli_query($connection,$query);
    if(!$stock_query){
        die("query failed");
    }else{
...
<body>
    ...
    <!--main content start-->
      ...
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Adding New Products in The Stock</h3>
            ...
            <div class="form-panel" >
              <form class="form-horizontal style-form" method="post">
               <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="pname" class="form-control round-form" required="true">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Quantity</label>
                  <div class="col-sm-4">
                    <input type="text" name="quantity" class="form-control round-form" required="true">
                  </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Product Type</label>
                    <div class="col-sm-4">
                    <select  name="type" class="form-control round-form" required="true">
