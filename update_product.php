...
<body>
    ...
    <!--main content start-->
      ...
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Updating Products in The Stock</h3>
            ...
            <div class="form-panel" >
              <form class="form-horizontal style-form" method="post">
                            ...
                            if(isset($_POST['update'])){
                                       ...
                                       $type = $_POST['type'];
                                        ...
                                        $query = "update stock set quantity ='{$quantity}' where id = '{$id}' ";
                                            $select_update = mysqli_query($connection, $query);
                                            if(!$select_update){
                                                die("query failed");
                                            }
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="text" name="pname" class="form-control round-form" value='<?php echo  $name ?>' required="true">
                  </div>
                </div>
                <div class="form-group">
                  <label class="col-sm-2 col-sm-2 control-label">Quantity</label>
                  <div class="col-sm-4">
                    <input type="text" name="quantity" class="form-control round-form" value='<?php echo  $quantity ?>' required="true">
                  </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 col-sm-2 control-label">Product Type</label>
                    <div class="col-sm-4">
                    <select  name="type" class="form-control round-form" value='<?php echo  $type ?>' required="true">
                        <option>Soft_Drink</option>
                ...
                <button type="submit"  name="update" class="btn btn-large btn-primary">Update</button>
                 ...
                 <a href="stock.php"><button  class="btn btn-large btn-primary">view stock</button></a>
            </div>
          </div>
          <!-- col-lg-12-->
        </div>
