...
if(isset($_POST['done']))
{
    ...
    $query = "insert into bills(username,id,name,price,quantity) select username,id,name,price,quantity from orders where id = '$user_id'";
    $copy = mysqli_query($connection, $query);
    
    $query2 = "delete from orders where id = '$user_id'";
          ...
          <div class="row content-panel">
            <div class="col-lg-10 col-lg-offset-1">
              <div class="invoice-body">
                <div class="pull-left">
                  <h1>BLOOM BACK HOTEL</h1>
                  <address>
                795 Ave, kk<br>
                KIGALI - RWANDA<br>
                <abbr title="Phone">P:</abbr> (+250) 789009876
              </address>
                </div>
                <!-- /pull-left -->
...
-->
                    <tr>
                      <td colspan="2" rowspan="4">
                           <?php 
                            $subtotal = (int)$total * 18 / 100;
                            $final = (int)$total - (int)$subtotal;
                        ?>
                        ...
                        <td class="text-right"><?php echo $final ?>Rwf</td>
                       
                    </tr>
                    <tr>
                      <td class="text-right no-border"><strong>18% VAT Included in Total</strong></td>
                      <td class="text-right"><?php echo $subtotal ?>Rwf</td>
                    </tr>
                    <tr>
                      <td class="text-right no-border">
                        <div class="well well-small green"><strong>Total</strong></div>
                      </td>
                      <td class="text-right"><strong><?php echo $total ?>Rwf</strong></td>
                      ...
                      <tr>
                        <td>
                            <form action="order_details.php" method="post">
                                <button type="submit"  name="done" class="btn btn-large btn-primary">DONE</button>
                            </form>
