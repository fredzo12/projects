...
<body>
    ...
    <!--main content start-->
      ...
      <section class="wrapper">
        ...
        <h6> Feel free to tell us anything... we are here to serve you</h6>
          ...
          <div class="col-lg-6 col-md-6 col-sm-6">
            ...
            <form class="contact-form php-mail-form" role="form" >
              ...
              <div class="form-group">
                <input type="name" name="name" class="form-control" id="contact-name" placeholder="Your Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" required="true" >
