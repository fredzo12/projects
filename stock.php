...
<body>
    ...
    <!--main content start-->
      ...
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Stock Available</h3>
          
           <div class="form-send">
                <a href="add_product.php"><button   name="add"  class="btn btn-large btn-primary">ADD NEW PRODUCTS</button></a>
              </div>
                  ...
                  <tr>
                    ...
                    <td>
                         <div class="pull-right hidden-phone">
                          <a href='update_product.php?edit=<?php echo $stock_id  ?>'><button class="btn btn-primary btn-xs" name="pencil"><i class="fas fa-pencil-alt"></i></button></a>
