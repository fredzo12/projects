...
<body>
    ...
    <!--main content start-->
      ...
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> Drinks and Food</h3>
        <!-- SIMPLE TO DO LIST -->
        <div class="row mt">
          <div class="col-md-12">
                ...
                <div class="pull-left">
                    <?php 
                        ...
                        if(isset($_POST['checkboxArray'])){
                                    ...
                                    foreach($_POST['checkboxArray'] as $result){
                                    ...
                                    while($row = mysqli_fetch_assoc($select_query)){
                                            $id = $row['id'];
                                                ...
                                                if($id == $result ){
                                                   ...
                                                   $query = "insert into orders(username,id,name,price) values('$username','$user_id','$names','$price')";
                                                   $results = mysqli_query($connection, $query); 
                                                    if(!$results){
                                                        die("query failed" . mysqli_error($connection));
                                                    }
                                                    
                                                  $query2 = "update drinks set quantity = '$newquantity' where id = $id";
                    ...
                    <?php } ?>
                    <h4><?php echo "added succesfully"; ?></h4>
                       <?php }?>
                    <a href="order_details.php">view order details</a>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        ...
                        <span class="check"><input type="checkbox" class="checked" name='checkboxArray[]' value='<?php echo  $id; ?>'></span>
                        <a name="name"><?php echo $name ?></a>
                          <a name="name"><?php echo $price ?>rwf</a>
